...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Bree+Serif&family=Lato:wght@300;400;700&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="app/css/gjp.css">
    <script>
        function myFunction() {
...
<body>
    ...
    <! --- Script for stop form refreshing page on submit --->
        ...
        <script src="app/js/gjp.js"></script>
</body>
